...
void DIO_Set_High_Nibble_Direction(u8 PORT_NO,u8 HIGH_NIBBLE_DIRECTION){ // dir = 1 -> output , dir = 0 -> input
...
void DIO_Set_Low_Nibble_Direction(u8 PORT_NO,u8 LOW_NIBBLE_DIRECTION){ // dir = 1 -> output , dir = 0 -> input
